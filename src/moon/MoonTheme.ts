...
module moon
{
	...
	*/
	...
	export class GameData{
		...
		/**游戏局数 */
		public static gameIndex:number=0;
		/**游戏总局数 */
		public static readonly GAMESNUMBER:number=6;
		/**生命值 */
		public static readonly BLOOD:number=18;

		/**广告出现次数统计 */
		public static adver_sum: number = 0;  // 是要加入到uploadMessage中的
		/** 视频广告点击时机 */
		public static video_tap: Array<number> = [-1,-1,-1];
		/**上传数据 */
		public static uploadMessage: Array<Array<any>> = [];
		/**上传用户信息 */
		public static uploadUser: object={
            names: "unknown",
            fullscore: 0,
            maxscore: 0
		};
		/** 游戏序列 */
		public static gameType:Array<number> = [0,1,2,3,4,5];
		/** 问题序列 */
		public static questionList:object;

		/** 是否是预实验 */
		public static preGame:boolean = true;
		/** 排行榜 */
        public static RankList:Array<object> = [];
