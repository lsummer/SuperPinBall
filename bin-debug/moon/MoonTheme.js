...
(function (moon) {
    ...
    moon.GAMETYPE = GAMETYPE;
    __reflect(GAMETYPE.prototype, "moon.GAMETYPE");
    var FONT = (function () {
        function FONT() {
        }
        FONT.fontName = "黑体";
    ...
    */
    ...
    var GameData = (function () {
        ...
        /**游戏总局数 */
        GameData.GAMESNUMBER = 6;
        /**生命值 */
        GameData.BLOOD = 18;
        /**广告出现次数统计 */
        GameData.adver_sum = 0; // 是要加入到uploadMessage中的
        /** 视频广告点击时机 */
